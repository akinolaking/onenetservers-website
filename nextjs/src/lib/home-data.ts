...
export const tlds = [
  { ext: ".ng",      usd: 23.40,  ngn: 43000,  gbp: 21.79, note: "NiRA" },
  { ext: ".com",     usd: 15.00,  ngn: 27570,  gbp: 13.97, note: "" },
  { ext: ".com.ng",  usd: 11.25,  ngn: 20750,  gbp: 10.47, note: "NiRA" },
  { ext: ".co.uk",   usd: 8.12,   ngn: 14925,  gbp: 7.56,  note: "" },
  { ext: ".uk",      usd: 8.12,   ngn: 14925,  gbp: 7.56,  note: "" },
  { ext: ".shop",    usd: 4.99,   ngn: 9172,   gbp: 4.65,  note: "" },
  { ext: ".online",  usd: 3.80,   ngn: 6984,   gbp: 3.54,  note: "" },
  { ext: ".xyz",     usd: 3.42,   ngn: 6286,   gbp: 3.18,  note: "Lowest" },
  { ext: ".dev",     usd: 19.04,  ngn: 34995,  gbp: 17.73, note: "" },
  { ext: ".tech",    usd: 10.79,  ngn: 19832,  gbp: 10.04, note: "" },
  { ext: ".me",      usd: 30.29,  ngn: 55673,  gbp: 28.20, note: "" },
  { ext: ".io",      usd: 44.44,  ngn: 81681,  gbp: 41.37, note: "" },
  { ext: ".ai",      usd: 95.24,  ngn: 175071, gbp: 88.67, note: "" },
  { ext: ".net",     usd: 36.01,  ngn: 66162,  gbp: 33.53, note: "" },
  { ext: ".org",     usd: 32.50,  ngn: 59735,  gbp: 30.26, note: "" },
  { ext: ".biz",     usd: 20.80,  ngn: 38230,  gbp: 19.36, note: "" },
  { ext: ".info",    usd: 10.92,  ngn: 20071,  gbp: 10.17, note: "" },
...
export const services = [
  ...
  },
  {
    ...
    price: { USD: "$3.42/yr", NGN: "₦6,286/yr", GBP: "£3.18/yr" },
    href: "/domains",
    ...
    plans: [
      {
        ...
        annual:  { USD: "$4.05/mo", NGN: "₦5,582/mo", GBP: "£2.83/mo" },
    ...
    plans: [
      {
        ...
        annual:  { USD: "$11.18/mo", NGN: "₦900/mo",   GBP: "£8.21/mo" },
